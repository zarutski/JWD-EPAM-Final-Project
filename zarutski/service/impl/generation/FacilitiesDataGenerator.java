...
public class FacilitiesDataGenerator {
    ...
    private static final String SWIFT_NUMBER = "UNBS";
    private static final String DEFAULT_BALANCE_ACC = "3014";
    public static final String BANK_BIN_CODE = "46101";
    ...
    public static final int VISA_CODE = 4;
    public static final int MASTERCARD_CODE = 5;
