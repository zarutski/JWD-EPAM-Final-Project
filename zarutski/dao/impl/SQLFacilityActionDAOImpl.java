...
// TODO --- refactor (+порядок полей)
public class SQLFacilityActionDAOImpl implements FacilityActionDAO {

    private static final Logger logger = LogManager.getLogger(by.epamtc.zarutski.dao.impl.SQLFacilityActionDAOImpl.class);
    ...
    public static final String INSERT_INTO_CREDIT_CARDS = "INSERT INTO credit_cards " +
    ...
    public static final int INITIAL_STATE_CODE = 1;

    public static final String INSERT_ACC_HAS_CARDS = "INSERT INTO accounts_has_credit_cards " +
    ...
    public static final String LOG_WRONG_CARD_STATE = "wrong card state";
    ...
    public static final String CHANGE_CARD_STATE = "UPDATE credit_cards SET state_code = ? WHERE credit_card_id = ?";
    ...
    public static final String WHERE_ACC_NUMBER = " WHERE a.number=?";


    private static final String SELECT_ACCOUNT_NUM_BY_CARD_NUM = "SELECT a.number FROM credit_cards AS credit_c " +
            ...
            "INNER JOIN account_states AS a_s ON a.state_code=a_s.state_code " +
            "INNER JOIN currences AS c ON a.currences_id=c.currences_id " +
            "WHERE credit_c.credit_card_number=? AND c.currency=?";
    ...
    // TODO --- порядок констант, методов --- имена
    // TODO --- ЖЁСТКИЙ РЕФАКТОР
    @Override
    public boolean transfer(TransferData transferData) throws DAOException {
        ...
        Account destinationAccount = getAccByNumber(destinationAccNumber); // ВТОРОЙ SELECT
    ...
    private String getDestAccNumber(TransferData transferData) throws DAOException {
        ...
        if (transferFromCard(transferData)) {
            ...
            String cardAccNum = getAccByCardNumber(receivedNumber, cardCurrency);
    ...
    private String getConfirmationCode(int cardId) throws DAOException {
        ...
        try {
            ...
            if (resultSet.next()) {
                confirmation = resultSet.getString(COLUMN_CVV_CODE);
            }
    ...
    private String getAccByCardNumber(String cardNumber, String currency) throws DAOException {
        Connection con = null;
        PreparedStatement ps = null;
        ResultSet resultSet = null;
        ...
        try {
            ...
            if (resultSet.next()) {
                accNumber = resultSet.getString(COLUMN_NUMBER);
            }
