...
public class CardTag extends TagSupport {
    ...
    public static final String TYPE_VISA = "<br>[visa]<br>";
    public static final String TYPE_MASTERCARD = "<br>[mastercard]<br>";

    public static final String LOG_ERROR = "Error writing card tag";
