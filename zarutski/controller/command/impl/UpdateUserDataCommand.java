...
public class UpdateUserDataCommand implements Command {
    ...
    public static final String LOG_WRONG_UPDATE_DATA = "Update data format isn't correct";
    public static final String LOG_SUCCESSFUL = "User data update finished successfully";
