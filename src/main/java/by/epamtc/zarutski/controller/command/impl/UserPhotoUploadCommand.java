...
public class UserPhotoUploadCommand implements Command {
    ...
    private static final String PARAMETER_WRONG_EXTENSION_ERROR = "&photo_message=wrong_extension";
    ...
    private static final String LOG_WRONG_EXTENSION = "Wrong file extension";
