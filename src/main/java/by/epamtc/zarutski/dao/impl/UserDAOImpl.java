...
public class UserDAOImpl implements UserDAO {
    ...
    private static final String FILE_DIR = "http://localhost:8080/uploaded_files/tbank/";
    private static final String USER_PHOTO_PREFIX = "user_photo_profile_";
    private static final String DOWNLOAD_DIR = "C:\\Users\\Random\\eclipse-workspace\\.metadata\\.plugins\\" +
    ...
    private static final String LOG_WRONG_DATA = "wrong data for updating user details";
    ...
    private static final String LOG_WRITING_FILE_ERROR = "writing file error";
    private static final String LOG_PREVIOUS_PHOTO = "prev photo was deleted";
